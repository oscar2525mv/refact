...
public class GestionPersonnelTest {
    ...
    public void testAjoutDeveloppeur() {
        ...
        assertThat(emp.nom()).isEqualTo("Alice");
    ...
    public void testAvancementEmploye() {
        ...
        var emp = gestion.employes.get(0);
        assertThat(emp.type()).isEqualTo("DEVELOPPEUR");
    ...
    public void testAvancementEmployeIncorrect() {
        ...
        var emp = gestion.employes.get(0);
        assertThat(emp.type()).isEqualTo("STAGIAIRE");
    }
    ...
    public void testGetEmployesParDivision() {
        ...
        ArrayList<Employe> itTeam = gestion.getEmployesParDivision("IT");
        assertThat(itTeam).hasSize(2);
        assertThat(itTeam).extracting(e -> e.nom()).containsExactlyInAnyOrder("Alice", "Charlie");
    }
    ...
    public void testGetEmployesParDivisionPlusieurs() {
        ...
        ArrayList<Employe> itTeam = gestion.getEmployesParDivision("IT");
        assertThat(itTeam).hasSize(2);
        assertThat(itTeam).extracting(e -> e.nom()).contains("A", "B");
    }
